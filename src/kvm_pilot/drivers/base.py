...
class VirtualMedia(Protocol):
    ...
    # bool | None: the PiKVM family reports "request sent" (bool); the BMC/fake
    # drivers return None. Callers must key off get_msd_state(), not this (#243).
    def msd_connect(self) -> bool | None: ...
